...
<img src="{% asset_path montage2.jpg %}" alt="My Image" />
...
<div class="imageTable">
    <table>
        <tbody>
            <tr>
                <td>
                 	<img src="{% asset_path moRy14.gif %}" alt="My Image" />
                	<div class="caption">		
    	            	American POW Jeremiah Denton blinking in Morse code.
                	</div>
               </td>
                <td>
                	<img src="{% asset_path img0273.png %}" alt="My Image" />                	
                	<div class="caption">
...
<div class="row">
	<div class="medium-6 small-12 columns">		
		...
		<img class="autoResizeImage" src="{% asset_path Eye_of_Horus.svg %}" />
	</div>
	<div class="medium-6 small-12 columns ">	
		but inside the computer the image is represented differently:
		<img src="{% asset_path pixels.svg %}">
		<!--<img src="your.svg" onerror="this.src='your.png'">-->
		<!-- <img class="autoResizeImage" src="{% asset_path lena_0.jpg %}" /> -->
	</div>
</div>	
...
<div class="row" style="display: table-cell; vertical-align: middle;">
	<div class="small-3 small-offset-1 columns" style="position: relative; top: 50%; transform: translateY(25%);">
	    <img src="{% asset_path lena_0.jpg %}" alt="My Image" />
	    Target image
	</div>
	<div class="small-3 columns" style="position: relative; top: 50%; transform: translateY(25%);" >
	    <img src="{% asset_path mandrill_orig.jpg %}" alt="My Image" />
	    Secret image
	</div>
	<div class="small-4 columns end">
	    <img src="{% asset_path hidden.jpg %}" alt="My Image"  style="border-left: 2px solid white;" />
...
<div class="row" id="lsbSliderDiv" style="position:relative;">
	<div class="small-3 columns" style="text-align: left;">
		<img src="{% asset_path lena_0.jpg %}" style="width:75%; margin-bottom:10px;" alt="My Image" id=
		"lsbSliderSource" /> <br/>
		<img src="{% asset_path mandrill_orig.jpg %}" style="width:75%; " alt="My Image" id=
		"lsbSliderTarget"/>
	</div>
	<div class="small-4 columns">
	    <img src="{% asset_path lena_0.jpg %}" alt="My Image"  id="lsbSliderImage" />
...
<img src="{% asset_path mask.jpg %}" alt="My Image" />
...
<img src="{% asset_path palette.jpg %}" alt="My Image" />
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_1.jpg %}" />    
                	<div class="caption">
                		1-bit distortion<br>
                		capacity: 12.5%<br>
                		psnr: 51.14
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_2.jpg %}" />                    
                	<div class="caption">
                		2-bit distortion<br>
                		capacity: 25%<br>
                		psnr: 44.14
			...
			<tr>
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_3.jpg %}" />                    
                	<div class="caption">
                		3-bit distortion<br>
						capacity: 37.5%<br>
						psnr: 37.90
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_4.jpg %}" />                   
                	<div class="caption">		
    	            	4-bit distortion<br>
						capacity: 50%<br>
						psnr: 31.77
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_5.jpg %}" />                    
                	<div class="caption">
                		5-bit distortion<br>
						capacity: 62.5%<br>
						psnr: 25.72                	
            ...
            <tr>
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_6.jpg %}" />                    
                	<div class="caption">
						6-bit distortion<br>
						capacity: 75.0%<br>
						psnr: 19.89
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_7.jpg %}" />                    
                	<div class="caption">
						7-bit distortion<br>
						capacity: 87.5%<br>
						psnr: 13.99
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_8.jpg %}" />                    
                	<div class="caption">
						8-bit distortion<br>
						capacity: 100%<br>
						psnr: 8.67
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path lena_ycbcr.jpg %}" />    
                	<div class="caption">
...
<img src="{% asset_path bpcs_diagram.jpg %}" alt="My Image" />
...
<div class="imageTable">
    <table>
        <tbody>
            <tr>
                <td>
                	<img class="autoResizeImage" src="{% asset_path house_orig.jpg %}" />
                	<div class="caption">
      	          		Original image<br>
                		<br>
                		<br>             
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path bpcs_house.jpg %}" />                    
	             	<div class="caption">		
...
<img class="autoResizeImage" src="{% asset_path abcde_diagram.jpg %}" />                   
...
<div class="imageTable">
    <table>
        <tbody>
            <tr>
                <td>
                	<img class="autoResizeImage" src="{% asset_path check_orig.jpg %}" />
                	<div class="caption">
      	          		A checkerboard pattern                		
            		</div>	       
                </td>
                <td>
                	<img class="autoResizeImage" src="{% asset_path check_bpcs.jpg %}" />                    
	             	<div class="caption">		
...
<div class="imageTable">
    <table>
        <tbody>
            <tr>
                <td>
                	<img class="autoResizeImage" src="{% asset_path mandrill_orig.jpg %}" />
                	<div class="caption">
      	          		Original image<br>
      	          		<br>
      	          		<br>   		
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path mandrill_abcde.jpg %}" />                    
	             	<div class="caption">		
...
<div class="imageTable">
    <table>
        <tbody>
            <tr>
                <td>
                	<img class="autoResizeImage" src="{% asset_path peppers_orig.jpg %}" />
                	<div class="caption">
      	          		Original image<br>
      	          		<br>
      	          		<br>   		
                ...
                <td>
                	<img class="autoResizeImage" src="{% asset_path spread_peppers.jpg %}" />                    
	             	<div class="caption">	
	             		Image after spread spectrum watermarking.<br>
						psnr: 35.87	
                	</div>
            		<img class="autoResizeImage" src="{% asset_path spread_error.jpg %}" />                    
	             	<div class="caption">	
...
<img class="autoResizeImage" src="{% asset_path iadct_resize.jpg %}" />                    
Encoded image after shrinking by 50%

<img class="autoResizeImage" src="{% asset_path spread_resize_stem2.jpg %}" />                    
Watermark detection from resized image (watermark @ 50)

<img class="autoResizeImage" src="{% asset_path iadct_jpg.jpg %}" />                    
Encoded image after JPEG compression with quality = 10

<img class="autoResizeImage" src="{% asset_path spread_jpeg_stem2.jpg %}" />                    
...
<img class="autoResizeImage" src="{% asset_path iadct_resize_stem.jpg %}" />
Watermark detection from resized image

<img class="autoResizeImage" src="{% asset_path iadct_jpg.jpg %}" />
Encoded image after JPEG compression

<img class="autoResizeImage" src="{% asset_path iadct_jpg_stem.jpg %}" />
Watermark detection after JPEG compression with quality=10
