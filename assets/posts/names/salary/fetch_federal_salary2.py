...
LOG_FILENAME = "fed_salary_log.log"
...
def main():
    ...
    paging_count = int(2098188) / num_display
    ...
    while paging_count > 0:
        ...
        paging_count -= 1
        i+=1
        filename = "salary2_" + str(i) + ".p"
        pickle.dump( cleaned_data, open( filename, "wb" ), pickle.HIGHEST_PROTOCOL )
        # TODO: Add retry
        time.sleep(30)
